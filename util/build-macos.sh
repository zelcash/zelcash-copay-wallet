...
ln -s ../resources/zelcash/mac/dmg-background.tiff dmg-background.tiff
rm volume-icon.icns
ln -s ../resources/zelcash/mac/volume-icon.icns volume-icon.icns
...
then
  ...
  export IDENTITY="3rd Party Mac Developer Application: Zel Technologies GmbH (ID HERE)"
